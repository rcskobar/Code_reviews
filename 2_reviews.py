...
#----------------------------------------------------------------------------------------------------------------------
	def __init__ (self, root):
		...
		self.lection_number_label = Label(root, text = "Номер лекции (по счету на сайте во вкладке лекции)",
										  bg = "peru", font = "Courier 20")
...
#-----------------------------------------------------------------------------------------------------------------------
#MAIN MENU
# крч тут забирается название группы и тупым форматирование текста вставляется в запрос
	def chrome (self, event):
		...
		while True:
			...
			if message_id == 1:
				message.click()
			number_lection = "/html/body/div[2]/div[2]/div/div[2]/div/div/div/div/div/div[2]/table/tbody/tr[{0}]/" \
							 "td[6]/a".format(str(self.lection_number.get()))
